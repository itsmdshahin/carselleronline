  ...
  <img src="../../../../images/ca7.jpg" alt="Logo" />
        ...
        <div className="left1">
          <p>It is a long established fact that a reader will be distracted by the readable content of a page when
            ...
            by accident
            sometimes on purpose (injected humour and the like).</p> <br />

          <div className="left2">
            <p>12420 Auto Drive clarksville,MD 21029 <br />


              <a class="address " href=" http://www.antwerpentoyota.com">Maps & Directions</a> <br />

              Sales: <a class="cell" >(880)12345678</a> <br />
              Services: <a class="cell">(880)123456</a></p>
          </div>
        </div>
        <div className="right">
          <p>Today 9.00 AM-7.00 PM(Closed Now) <br /></p>
          <p class="link">Show Business Hour</p>
      ...
      <div className="deals">
        ...
        <div className="img1">
          <Card >
          <Button class="btn">Start Purchasing</Button>
            <Card.Img src="../../../../images/ca6.jpg" />
            <h3>2015 Marcedes-Benz Sprinter Cab</h3>
            <p>$25,500 <br />

              163,383 mi <br /> Clarksville,MD</p>
              <a class="cell2" >(880)12345678</a> <br />
            
              <Button class="btn2">Request Info</Button>
          </Card>
        </div>
        <div className="img2">
          <Card >
